...
FREE_SERVERS.extend(['upvtv','montecarlo','dplay','azteca','vtelevision','dwspan','pakapaka','onceninos','euronews','canal22','trececl','canal10','adn40','levantetv','populartvlarioja','rtva'])
